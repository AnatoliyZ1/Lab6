...
Y1 = [round(
    3.9 + 5.6 * X1[i] + 7.9 * X2[i] + 7.3 * X3[i] + 2.0 * X1_kv[i] + 0.5 * X2_kv[i] + 4.2 * X3_kv[i] + 1.5 * X12[i]
    + 0.1 * X13[i] + 9.9 * X23[i] + 5.3 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
Y2 = [round(
    3.9 + 5.6 * X1[i] + 7.9 * X2[i] + 7.3 * X3[i] + 2.0 * X1_kv[i] + 0.5 * X2_kv[i] + 4.2 * X3_kv[i] + 1.5 * X12[i]
    + 0.1 * X13[i] + 9.9 * X23[i] + 5.3 * X123[i] + random.randrange(-10, 10) - 5, 3) for i in range(15)]
Y3 = [round(
